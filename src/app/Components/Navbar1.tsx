            ...
            <div className='flex justify-between h-20'>
                ...
                <Link className='text-gray-800 hover-golden-600 px-3 py-2 text-base font-poppinsSemiBold' href="OnlyImages">Contact</Link>
                 ...
                 <div className='flex items-center md:hidden'>
                    <button className='inline-flex items-center justify-center p-2 rounded-md text-gray-800 hover:text-gray-600 focus:outline-none focus-ring-2 focusring-inset focus:ring-gray-500'>
